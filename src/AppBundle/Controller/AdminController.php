...
class AdminController extends Controller
{
    ...
    public function viewAllOutstandingOrdersAction(Request $request)
    {
        ...
        $sql = "
            select p.id, c.id as cart_id, c.approved, 
                   p.return_ship_date, p.return_received_date, p.quantity, p.ship_quantity, 
                   ...
                   c.requester_last_name) as submitted_by, CONCAT_WS(\" \", u2.first_name, u2.last_name) as approved_by, 
